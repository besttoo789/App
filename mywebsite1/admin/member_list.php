              ...
              <table id="example_1" class="table table-bordered table-striped table-hover table-sm">
                ...
                <tbody>
                  ...
                  <tr class="table-row">
                    ...
                    <td><?=$row['username'];?></td>
                    <td align="center">
                      <span class="badge <?php echo $row['m_level'] == 'admin' ? 'badge-success' : 'badge-info'; ?>">
                        <?=$row['m_level'];?>
                      </span>
                    </td>
                    <td align="center">
                      <a href="member.php?id=<?=$row['id'];?>&act=editPwd" class="btn btn-info btn-sm btn-action">
                        <i class="fas fa-key mr-1"></i> 
                      </a>
                    </td>
                    <td align="center">
                      <a href="member.php?id=<?=$row['id'];?>&act=edit" class="btn btn-success btn-sm btn-action">
                        <i class="fas fa-edit"></i>
                      </a>
                    </td>
                    <td align="center">
                      <a href="member.php?id=<?=$row['id'];?>&act=delete" class="btn btn-danger btn-sm btn-action" 
